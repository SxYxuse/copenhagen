...
const prettyCodeOptions = {
	theme: {
		dark: JSON.parse(
			String(readFileSync(resolve(__dirname, './src/lib/styles/themes/serendipity-midnight.json')))
		),
		light: JSON.parse(
			String(readFileSync(resolve(__dirname, './src/lib/styles/themes/serendipity-morning.json')))
		)
	},
